...
const ITENS = [
  { href: "/pessoal", label: "Resumo" },
  { href: "/pessoal/funcionarios", label: "Funcionários" },
  { href: "/pessoal/folha", label: "Folha do mês" },
  { href: "/pessoal/esocial", label: "eSocial" },
];

export function PessoalSubnav() {
