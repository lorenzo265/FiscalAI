...
export function PassoPagamento() {
  ...
  return (
    <Framed marks tone="ink" surface="card" className="flex flex-col gap-4 max-w-2xl">
      <div className="flex items-center gap-2">
        <CreditCard className="size-4 text-[var(--color-ink-3)]" aria-hidden />
        <Fig n={3} titulo="Como o cliente vai pagar?" />
      </div>
      <Ruler />
