...
| **4** | **X17 monitores de limite ✅ (2026-06-21)** · X19 motion overlays ⚠️ revertido (PR dedicado: `@utility`/Framer) · X15 onboarding CNPJ-first (lógica) · X16 assistente real (backend) · X18 brand pack · X14 "fechar o mês" (backend S5) | em curso — resto conforme credenciais/backends do PO |
